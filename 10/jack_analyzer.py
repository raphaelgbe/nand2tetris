...
class JackAnalyzer:
    def __init__(self, input_path, generate_tokens_file):
    ...
    def _perform_syntax_analysis(self):
        for filename, jack_file in self.jack_files.items():
            output_filename = filename.replace(".jack", "_test.xml")
            ...
            self._write_output_file(ce.parsed, output_filename)
...
if __name__ == "__main__":
    ...
    ja = JackAnalyzer(args.input, args.generate_tokens_file)