class Parser:
    ...
    def arg1(self):
        if self.command_type() == "C_ARITHMETIC":
            ...
            raise NotImplementedError("Arg 1 not implemented yet for branching & call/function/return types")
    ...
    def arg2(self):
        if self.command_type() == "C_ARITHMETIC":
            ...
            raise NotImplementedError("Arg 2 not implemented yet for branching & call/function/return types")
